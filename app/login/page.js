...
const Login = () => {
  ...
  const createGoogleAuthLink = async () => {
    try {
      ...
      const url = `${process.env.NEXT_PUBLIC_SERVER}/api/google/createAuthLink`
  ...
  return (
    <div>
      <div class="relative overflow-hidden  h-[100vh]">

        <div class="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-20 lg:py-32 md:px-8 border-black h-full items-center flex  ">
          <div class="md:pr-8 md:w-1/2 xl:pr-0 xl:w-5/12">
            <h1 class="text-3xl text-gray-800 font-bold md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight dark:text-gray-200">
              Solving problems for every <span class="text-red-600 dark:text-red-500">Youtuber</span>
            </h1>
